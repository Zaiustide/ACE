...
VALUES (451601701, 'ace451601701-Metos', 10, '2026-04-06 05:53:34') /* Creature */;
...
VALUES (451601701,   1,         16) /* ItemType - Creature */
     ...
     , (451601701, 308,         50) /* DamageResistRating */
...
VALUES (451601701,  0,  4,  0,    0,  735,  441,  698,  441,  698,  735,  661,  698,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head - Bludgeon */
     , (451601701,  1,  4,  0,    0,  735,  441,  698,  441,  698,  735,  661,  698,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest - Bludgeon */
     , (451601701,  2,  4,  0,    0,  735,  441,  698,  441,  698,  735,  661,  698,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen - Bludgeon */
     , (451601701,  3,  4,  0,    0,  735,  441,  698,  441,  698,  735,  661,  698,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm - Bludgeon */
     , (451601701,  4,  4,  0,    0,  735,  441,  698,  441,  698,  735,  661,  698,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm - Bludgeon */
     , (451601701,  5,  4,800, 0.75,  735,  441,  698,  441,  698,  735,  661,  698,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand - Bludgeon */
     , (451601701,  6,  4,  0,    0,  735,  441,  698,  441,  698,  735,  661,  698,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg - Bludgeon */
     , (451601701,  7,  4,  0,    0,  735,  441,  698,  441,  698,  735,  661,  698,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg - Bludgeon */
     , (451601701,  8,  4,800, 0.75,  735,  441,  698,  441,  698,  735,  661,  698,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot - Bludgeon */;
...
VALUES (451601701, 1, 361842,  1, 0, 1, False) /* Create Spectral Heart of Metos (1) (361842) for Contain */
     , (451601701, 1, 361842,  1, 0, 1, False) /* Create Spectral Heart of Metos (1) (361842) for Contain */
     , (451601701, 1, 361842,  1, 0, 1, False) /* Create Spectral Heart of Metos (1) (361842) for Contain */
     , (451601701, 1, 361842,  1, 0, 1, False) /* Create Spectral Heart of Metos (1) (361842) for Contain */
     , (451601701, 1, 361842,  1, 0, 1, False) /* Create Spectral Heart of Metos (1) (361842) for Contain */
     , (451601701, 1, 361842,  1, 0, 1, False) /* Create Spectral Heart of Metos (1) (361842) for Contain */
