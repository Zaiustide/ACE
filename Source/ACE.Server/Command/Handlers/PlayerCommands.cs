...
namespace ACE.Server.Command.Handlers
{
    public static class PlayerCommands
    {
        ...
        public static void HandleShowXp(Session session, params string[] paramters)
        {
            ...
            session.Network.EnqueueSend(new GameMessageSystemChat($"\n--> The current max level for the day is {levelCap}.", ChatMessageType.System));
            ...
            session.Network.EnqueueSend(new GameMessageSystemChat($"\n--> You have currently earned {Formatting.FormatIntWithCommas((ulong)player.QuestXp)} quest xp for the day.", ChatMessageType.System));
            session.Network.EnqueueSend(new GameMessageSystemChat($"\n--> You have currently earned {Formatting.FormatIntWithCommas((ulong)player.PvpXp)} pvp xp for the day.", ChatMessageType.System));
            session.Network.EnqueueSend(new GameMessageSystemChat($"\n--> You have currently earned {Formatting.FormatIntWithCommas((ulong)player.MonsterXp)} monster xp for the day.", ChatMessageType.System));
