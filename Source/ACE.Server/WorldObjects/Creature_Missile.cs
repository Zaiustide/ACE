    ...
    partial class Creature
    {
        ...
        private void CreateSplitArrows(WorldObject weapon, WorldObject ammo, WorldObject target, Vector3 mainArrowOrigin, Quaternion mainArrowOrientation, Vector3 mainArrowVelocity)
        {
            try
            {
                ...
                var additionalArrowCount = splitCount - 1; // SplitArrowCount now directly represents number of split arrows to create
                ...
                {                    
                    ...
                    // DEBUG: Log details to find why AddObject fails
                    log.Info($"[SPLIT ARROW DEBUG] Before AddObject - Cell: 0x{splitProj.Location.Cell:X8}, Pos: {currOrigin}, PhysicsObj null: {splitProj.PhysicsObj == null}");
